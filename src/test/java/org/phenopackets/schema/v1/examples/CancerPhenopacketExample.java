...
class CancerPhenopacketExample {
    ...
    static Phenopacket cancerPhenopacket() {
        ...
        Biosample lymphNodeBiopsy = Biosample.newBuilder()
                ...
                .setId("sample1")
                .setAgeOfIndividualAtCollection(Age.newBuilder().setIso8601Duration("P48Y3M").build())
        ...
        Biosample esophagusBiopsy = Biosample.newBuilder()
                .setIndividualId(patientId)
                .setId("sample2")
                .setAgeOfIndividualAtCollection(Age.newBuilder().setIso8601Duration("P49Y2M").build())
        ...
        Biosample lungAutopsy = Biosample.newBuilder()
                .setIndividualId(patientId)
                .setId("sample3")
                .setAgeOfIndividualAtCollection(Age.newBuilder().setIso8601Duration("P50Y7M").build())
