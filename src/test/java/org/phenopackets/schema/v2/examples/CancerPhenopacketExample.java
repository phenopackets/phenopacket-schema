...
class CancerPhenopacketExample {
    ...
    static Phenopacket cancerPhenopacket() {
        ...
        Biosample lymphNodeBiopsy = Biosample.newBuilder()
                ...
                .setId("sample1")
                .setIndividualAgeAtCollection(TimeElement.newBuilder().setAge(Age.newBuilder().setIso8601Duration("P48Y3M")))
        ...
        Biosample esophagusBiopsy = Biosample.newBuilder()
                .setIndividualId(patientId)
                .setId("sample2")
                .setIndividualAgeAtCollection(TimeElement.newBuilder().setAge(Age.newBuilder().setIso8601Duration("P49Y2M")))
        ...
        Biosample lungAutopsy = Biosample.newBuilder()
                .setIndividualId(patientId)
                .setId("sample3")
                .setIndividualAgeAtCollection(TimeElement.newBuilder().setAge(Age.newBuilder().setIso8601Duration("P50Y7M")))
