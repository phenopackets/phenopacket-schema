...
# ones.
extensions = ['sphinx.ext.mathjax', 'sphinx.ext.mathjax','sphinx.ext.autosectionlabel']
...
copyright = u'2019, Julius OB Jacobsen, Peter N Robinson, Christopher J Mungall'
